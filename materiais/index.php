        ...
        <div class="lista" id="listaUsuario">
            ...
            <div class="filter-novo" id="trocaTelaB">
                <form action="" method="post" class="filter-novo-input">
                        ...
                        <input type="hidden"  name="" id="url" value="materiais">
                ...
                <div class="filter-novo-add">
                    <button onclick="trocaTelasMaterial()">+ &nbsp;Novo material</button>
                </div>
            </div>

            <div class="lista-usuario"  id="trocaTelaC">
                <ul>
                    <li style="font-size: 16px; color: #535353; font-family: 'Open Sans', sans-serif;">Nome do material</li>
                ...
                if(empty($_POST['rodar'])){$buscar_dados = mysqli_query($conexao, "select * from materiais");
                    
                
                }  if(isset($_POST['rodar'])){ $nome_cliente = $_POST['pesquisar'];
                    $buscar_dados = mysqli_query($conexao, "SELECT * from materiais where nome_material like '$nome_cliente%'");
                ...
                if(isset($_POST['cadastrarMaterial'])){
                    ...
                    $inserir = mysqli_query($conexao, "INSERT INTO materiais (nome_material) VALUES ('$nomeMaterial')");

                    echo "<script> alert('MATERIAL CADASTRADO COM SUCESSO!!'); location.href = '../materiais'; </script>";
                ...
                if(isset($_POST[$c])){
                    $delete = mysqli_query($conexao, "delete from materiais where nome_material = '$nome_material'");
                    echo "<script> location.href = '../materiais'; </script>";
                  }

                    echo "

                         <ul> 
                            <li id='usuario$c' name='usuario$c'>$nome_material</li>
